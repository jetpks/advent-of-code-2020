...
# 1. Read data.
# Instead of IO#readlines, just read the text directly so we can split on
# '\n\n'

# 2. Parse
# Def gonna make a child of Hash and add #validate and #parse_field. Gonna have
# to isolate the key/value pairs on /\s/.
